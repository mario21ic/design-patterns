        ...
        return new Iterator<String>() {
            ...
            public boolean hasNext() {
                if (Mochila.this.posicion >= 4) {
                    Mochila.this.posicion = 0; // resetear para volver a recorrer
                    return false;
                }
                return true;
            }
            ...
            public String next() {
                if (Mochila.this.contador != 0) {
                    ...
                    if (Mochila.this.posicion == 3 && Mochila.this.zona4 != null) {
                        // Mochila.this.posicion++;
                        Mochila.this.posicion = 4; // resetear posicion para poder volver a recorrer
                        return zona4;
                    }
                }
